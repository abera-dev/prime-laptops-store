            ...
            <form onSubmit={savePassword} className="card p-6">
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Field label="New Password">
                  <input className="input" type="password" minLength={12} value={passwords.new_password} onChange={e => setPasswords(p => ({ ...p, new_password: e.target.value }))} required />
                </Field>
                <Field label="Confirm Password">
                  <input className="input" type="password" minLength={12} value={passwords.confirm_password} onChange={e => setPasswords(p => ({ ...p, confirm_password: e.target.value }))} required />
                </Field>
              </div>
